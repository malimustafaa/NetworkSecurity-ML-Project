...
class ModelTrainer:
    ...
    def track_mlflow(self,model,classification_metric):
        try:
            with mlflow.start_run():
                '''
                Purpose: Starts a new MLflow run, which acts as a container for all the logged metrics, parameters, and artifacts related to a specific experiment or model.
                '''
                ...
                mlflow.log_metric("precisionn_score",precision_score)
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
         ...
         params = {
            ...
            "DecisionTree": {
                'criterion' : ['gini','entropy','log_boss']
         ...
         #best_model_name = [key for key,value in model_report.items() if value == best_model_score], both correct
